...
public class CryptoHash {
	static HashMap<String, String> HEX_TO_BIN_TABLE;
	static {
		HEX_TO_BIN_TABLE = new HashMap<String, String>();
	...
	public static String hex_to_binary(String hex_string) {
		...
		for (int i = 0; i<hex_string.length(); i++) {
			binary_string += HEX_TO_BIN_TABLE.get(String.valueOf(hex_string.charAt(i)));
		}
...
//		c.concat("foo","bar", "bat");
		...
		System.out.println(hex_to_binary("bf785e0d692d513ce4aa32d30633c30c520af7a7387c460c55eb4b6bf130ac74"));
